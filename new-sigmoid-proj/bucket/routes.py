...
from bucket.forms import RegistrationForm, LoginForm, RedirectToFolder, RenameFileForm, CreateFolderForm
from bucket.models import User 
from bucket.boto_s3 import create_folder, delete_folder, fetch_all_buckets,\
...
def home():
    ...
    if form.validate_on_submit():
        flash(f'Account created for {form.access_key.data}!', 'success')
